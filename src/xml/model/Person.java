...
@XmlType(propOrder = { "firstname", "lastname", "birthdate", "prefActivity" })
...
public class Person {
	...
	public Person(Long personId, String fname, String lname, String birthdate, Activity pa) {
		this.setPersonId(personId); 	
		this.setFirstname(fname);
		this.setLastname(lname);
		this.setBirthdate(birthdate); 	
		this.prefActivity=pa;
	}
	...
	public Person(Long personId, String fname, String lname, String birthdate) {
		...
		this.setLastname(lname);
		this.setBirthdate(birthdate); 
		this.prefActivity=new Activity();
	}
	...
	public Activity getHProfile() {
		return prefActivity;
	}
	public void setHProfile(Activity hProfile) {
		this.prefActivity = hProfile;
	}
